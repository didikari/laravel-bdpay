...
class FundDisbursementServiceTest extends TestCase
{
    protected FundDisbursementService $service;
    ...
    protected function setUp(): void
    {
        ...
        $this->service = new FundDisbursementService($this->mockClient);
    }
    ...
    public function test_throws_exception_for_missing_required_fields_in_create_disbursement()
    {
        $this->expectException(BDPayException::class);
        $this->expectExceptionMessage('Missing required fields');
        
        $this->service->createDisbursement([]);
    }
